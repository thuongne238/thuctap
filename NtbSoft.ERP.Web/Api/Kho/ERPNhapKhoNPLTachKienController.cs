...
{
    [RoutePrefix("api/ERPNhapKhoNPLTachKien")]
    public class ERPNhapKhoNPLTachKienController : ApiController
    {
        [HttpGet]
        [Route("Get")]
        ...
        {
            return new ERPNhapKhoNPLTachKienModel().Get(action, para, para2, para3, para4, para5, para6, para7);
        }
        ...
        {
            return new ERPNhapKhoNPLTachKienModel().Post(action, para, para2, para3, para4,tbl);
        }
        ...
        {
            return new ERPNhapKhoNPLTachKienModel().Delete(action, para, para2, para3, para4);
        }
    }
}