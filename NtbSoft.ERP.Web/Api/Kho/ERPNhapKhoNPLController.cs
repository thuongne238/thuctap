...
{
    [RoutePrefix("api/ERPNhapKhoNPL")]
    public class ERPNhapKhoNPLController : ApiController
    {
        [HttpGet]
        [Route("Get")]
        ...
        {
            return new ERPNhapKhoNPLModel().Get(action, para, para2, para3, para4, para5, para6, para7);
        }
