...
namespace NtbSoft.ERP.Web.Api.ThuVien
{
    ...
    [RoutePrefix("api/KHDT_Store")]
    public class KHDT_StoreController : ApiController
    {
        IKHDT_StoreRepository _repo = new KHDT_StoreRepository();
        [HttpGet]
        [Route("Get")]
        ...
        [HttpPost]
        [Route("Post")]
        public string Post(List<KHDT_StoreEntity> objSave)
        {
