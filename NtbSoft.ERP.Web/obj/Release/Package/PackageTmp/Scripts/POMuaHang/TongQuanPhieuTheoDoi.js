...
function fetchPhieuDanhGia(data) {
    ...
    /*    hoverStateEnabled: true,*/
        columns: [
            ...
            { dataField: "NgayDanhGia", caption: "Ngày tháng năm", dataType: "date", format: "dd-MM-yyyy", minWidth: 90, width: 100, },
            ...
            { dataField: "GhiChu", caption: "Ghi chú về sự không phù hợp" },
                            ...
                            $("<div>")
                                .dxCheckBox({
                                    ...
                                    onValueChanged: function (e) {
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: `/api/PhieuDanhGiaNhaCC/UpdateKetLuan?action=UpdateKLTheoDoiNCC&para1=${rowData.MaPhieuDG}&para2=${rowData.MaNhaCC}&para3=true`,
                                            success: function () {
                            ...
                            $("<div>")
                                .dxCheckBox({
                                    ...
                                    onValueChanged: function (e) {
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: `/api/PhieuDanhGiaNhaCC/UpdateKetLuan?action=UpdateKLTheoDoiNCC&para1=${rowData.MaPhieuDG}&para2=${rowData.MaNhaCC}&para3=false`,
                                            success: function () {
                                                DevExpress.ui.notify("Cập nhật kết luận thành công", "success", 2000);
                                            },
                                            error: function () {
            ...
            { dataField: "NguoiDanhGia", caption: "Người đánh giá" },
...
$("#btn-them-danh-gia").on("click", function () {
    let Action = 'add';
    let MaPhieu = 'NONE';
    window.location.assign("/POMuaHang/PhieuTheoDoi?ActionTheoDoi=" + Action + "&MaPhieu=" + MaPhieu + "&MaCLVTID=NONE");
});
...
$("#btn-sua-phieu").on("click", function () {
    ...
    window.location.assign("/POMuaHang/PhieuTheoDoi?ActionTheoDoi=edit" + "&MaPhieu=" + MaPhieu + "&MaCLVTID=" + MaCLVTID);
});
