...
async function LoadChiTietVTKiemKe(value) {
    ...
    const url = `/api/PhieuXuatHangNPL/GetTH?action=GetPhieuKiemKe&para1=${maVT}&para2=${soloid}&para3=${maHang}&para4=${maKH}&para5=${tuNgayFormat}&para6=${denNgayFormat}&para7=1`;
...
async function reloadKiemKeRightByMaVT(maVT) {
    ...
    const url = `/api/PhieuXuatHangNPL/GetTH?action=GetKiemKe&para1=${maNPL}&para2=${soloid}&para3=${maHang}&para4=${maKH}&para5=${tuNgayFormat}&para6=${denNgayFormat}&para7=1`;
