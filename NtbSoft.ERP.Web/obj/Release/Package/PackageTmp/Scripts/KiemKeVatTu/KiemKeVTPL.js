...
async function LoadChiTietVTKiemKe(value) {
    ...
    const url = `/api/PhieuXuatHangNPL/GetTH?action=GetPhieuKiemKe&para1=${maVT}&para2=${soloid}&para3=${maHang}&para4=${maKH}&para5=${phieuVTKK}&para6=${denNgayFormat}&para7=0`;
                    ...
                    const $btn = $('<button>')
                        ...
                        .click(function () {
                            showDeleteModal(rowData, async function () {
                                ...
                                const rowIndex = dxKiemKePhuLieuRight.getRowIndexByKey(rowData.BarCode);
                                dxKiemKePhuLieuRight.deleteRow(rowIndex);
...
async function reloadKiemKeRightByMaVT(maVT) {
    ...
    const denNgayFormat = $("#filterType").val() != "khachhang"
        ...
        : "1990-01-01";
    const phieuVTKK = $("#phieuvattukiem").val()
    const url = `/api/PhieuXuatHangNPL/GetTH?action=GetKiemKe&para1=${maNPL}&para2=${soloid}&para3=${maHang}&para4=${maKH}&para5=${phieuVTKK}&para6=${denNgayFormat}&para7=0`;
...
$(document).ready(function () {
    ...
    $("#phieuvattukiem").on("change", async function (e) {
        ...
        //const trangThai = $(this).data("#phieuvattukiem option:selected") == 1 ? "Đã Xác Nhận" : "Chưa Xác Nhận"
        //$("#ipTrangThai").css({
        //    "font-size": "14px",
        //    "color": $(this).data("#phieuvattukiem option:selected") == 1 ? `green` : `red`
        //}).val(trangThai);
...
$(function () {
    $("#confirmVT").on("click", function () {
        ...
        var grid = $("#dxKiemKePhuLieuLeft").dxDataGrid("instance");
...
async function CheckVatTuKiemKe(manpl) {
    ...
    const url = `/api/PhieuXuatHangNPL/GetTH?action=GetPhieuKiemKe&para1=${maVT}&para2=${soloid}&para3=${maHang}&para4=${maKH}&para5=${phieuVTKK}&para6=""&para7=0`;
