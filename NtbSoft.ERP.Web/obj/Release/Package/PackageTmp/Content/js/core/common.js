...
* Program name: Common method common.js
...
//Formatting time dd-MM-yyyy
com.formatDateDMY = function (value) {
...
com.formatTime1 = function (value) {
    return utils.formatDate(value, 'hh:mm:ss');
};

com.formatTimeYMDFull = function (value) {
    return utils.formatDate(value, 'yyyy-MM-dd hh:mm:ss');
};

com.formatStatus = function (value) {
    if (value == 0) return "Mới tạo"
    if (value == 1) return "Kích hoạt"
    if (value == 2) return "Đã đồng bộ";
    if (value == 3) return "Đã lập kế hoạch";
    if (value == 4) return "Đang sản xuất";
    if (value == -1) return "Đã hoàn thành";
...
com.message = function (type, message, callback) {
    switch (type) {
        ...
        case "error":
            if (parent == window) return alert(message);
            parent.$.messager.alert('error', message);
            break;
        case "warning":
            if (parent == window) return alert(message);
        ...
        case "information":
            ...
            break;
        case "confirm":
            return parent.$.messager.confirm('Confirm', message, callback);
    }
...
com.editGridViewModel = function (grid) {
    ...
    this.begin = function (index, row) {
        ...
        var ed = grid.datagrid('getEditors', self.editIndex);
        for (var i = 0; i < ed.length; i++) {
            var e = ed[i];
            if (e!=null && e.field == self.columnUpcase) {
    ...
    this.setReadonly = function (cell,row) {
        var col = grid.datagrid('getColumnOption', cell);
        var readonly = false;
        if (col && !row._isnew)
            col.editor = {};
        else {
    ...
    this.setReadonlyEditor = function (cell, row, editor) {
        var col = grid.datagrid('getColumnOption', cell);
        var readonly = false;
        if (col && !row._isnew)
            col.editor = {};
    ...
    this.setKeyUp = function (columnName) {
        self.columnUpcase=columnName
    };
};
...
com.auditDialog = function () {
    ...
    if (winAudit.length == 0) {
        ...
        html += '    <div id="w_audit_div" class="easyui-dialog"  title="Audit" data-options="modal:true,closed:true,iconCls:\'icon-user-accept\'" style="width:400px;height:210px;" buttons="#w_audit_div_button">'
        html += '        <div class="container_16" style="width:90%;margin:5%;">                                                                                  '
        html += '            <div class="grid_3 lbl" style="font-weight: bold;color:#7e7789">Approval Status</div>                                                       '
        html += '            <div class="grid_13 val">                                                                                                            '
        html += '                by<input type="radio" name="AuditStatus" value="passed" data-bind="checked:form.status" style="margin-right:10px;" />          '
        html += '                Fail<input type="radio" name="AuditStatus" value="reject" data-bind="checked:form.status" />                                   '
        html += '            </div>                                                                                                                               '
        html += '            <div class="grid_3 lbl" style="margin-top:5px;font-weight: bold;color:#7e7789" style="font-weight: bold;">Audit opinion</div>             '
        ...
        html += '        <a href="javascript:void(0)" data-bind="click:confirmClick" class="easyui-linkbutton" iconCls="icon-ok" >Ok</a>                        '
        html += '        <a href="javascript:void(0)" data-bind="click:cancelClick" class="easyui-linkbutton" iconCls="icon-cancel" >Cancel</a>                     '
        html += '    </div>                                                                                                                                       '
        html += '</div>';
...
com.auditDialogStatus = function () {
    var query = parent.$;
    var winAudit = query('#w_audit_div_02'), args = arguments;
    if (winAudit.length == 0) {
        var html = '<div id="w_audit_wrapper">'
        html += '    <div id="w_audit_div_02" class="easyui-dialog"  title="Duyệt" data-options="modal:true,closed:true,iconCls:\'icon-user-accept\'" style="width:400px;height:235px;" buttons="#w_audit_div_02_button">'
        html += '        <div class="container_16" style="width:90%;margin:5%;">                                                                                  '
        html += '            <div class="grid_3 lbl" style="font-weight: bold;color:#7e7789">Tình trạng</div>                                                       '
        html += '            <div class="grid_13 val">                                                                                                            '
        html += '                <input type="radio" name="ApproveState" value="1" data-bind="checked:form.status" style="margin-right:10px;" /> Kích hoạt        '
        html += '                <input type="radio" name="ApproveState" value="2" data-bind="checked:form.status" />                            Đã đồng bộ               '
        html += '                <input type="radio" name="ApproveState" value="4" data-bind="checked:form.status" />                            Đang SX  <br />                      '
        html += '                <input type="radio" name="ApproveState" value="-1" data-bind="checked:form.status" />                            Đã hoàn thành                    '
        html += '            </div>                                                                                                                               '
        html += '            <div class="grid_3 lbl" style="margin-top:5px;font-weight: bold;color:#7e7789" style="font-weight: bold;">Ghi chú</div>             '
        html += '            <div class="grid_13 val"><textarea style="width:272px;height:60px;" class="z-text" data-bind="value:form.comment" ></textarea></div> '
        html += '            <div class="clear"></div>                                                                                                            '
        html += '        </div>                                                                                                                                   '
        html += '    </div>                                                                                                                                       '
        html += '    <div id="w_audit_div_02_button" class="audit_button">                                                                                           '
        html += '        <a href="javascript:void(0)" data-bind="click:confirmClick" class="easyui-linkbutton" iconCls="icon-ok" >Ok</a>                        '
        html += '        <a href="javascript:void(0)" data-bind="click:cancelClick" class="easyui-linkbutton" iconCls="icon-cancel" >Cancel</a>                     '
        html += '    </div>                                                                                                                                       '
        html += '</div>';
        ...
        this.confirmClick = function () {
            ...
            for (var i = 0; i < args.length; i++) {
                if (typeof args[i] === 'function') {
                    args[i].call(this, ko.toJS(self.form));
                    break;
                }
            }
    ...
    if (winAudit.length == 0) {
        var html = utils.functionComment(function () {/*
            <div id="w_audit_wrapper">
                <div id="w_audit_div" class="easyui-dialog"  title="Audit" data-options="modal:true,closed:true,iconCls:'icon-user-accept'" style="width:400px;height:210px;" buttons="#w_audit_div_button"> 
                    <div class="container_16" style="width:90%;margin:5%;">  
                        <div class="grid_3 lbl" style="font-weight: bold;color:#7e7789">Approval Status</div>  
                        <div class="grid_13 val">
                            Approved<input type="radio" name="AuditStatus" value="passed" data-bind="checked:form.status,disable:disabled" style="margin-right:10px;" /> 
                            Cancel the review<input type="radio" name="AuditStatus" value="reject" data-bind="checked:form.status,disable:disabled" />
                        </div>
                        <div class="grid_3 lbl" style="margin-top:5px;font-weight: bold;color:#7e7789" style="font-weight: bold;">Audit opinion</div>  
                ...
                <div id="w_audit_div_button" class="audit_button">  
                    <a href="javascript:void(0)" data-bind="click:confirmClick" class="easyui-linkbutton" iconCls="icon-ok" >Ok</a>  
                    <a href="javascript:void(0)" data-bind="click:cancelClick" class="easyui-linkbutton" iconCls="icon-cancel" >Cancel</a>  
                </div> 
            </div>
            */});
        var wrapper = query(html).appendTo("body");
...
com.approveDialog = function () {
    var query = parent.$;
    var winAudit = query('#w_audit_div'), args = arguments;
    if (winAudit.length == 0) {
        var html = '<div id="w_audit_wrapper">'
        html += '    <div id="w_audit_div" class="easyui-dialog"  title="Approve" data-options="modal:true,closed:true,iconCls:\'icon-user-accept\'" style="width:400px;height:220px;" buttons="#w_audit_div_button">'
        html += '        <div class="container_16" style="width:90%;margin:5%;">                                                                                  '
        html += '            <div class="grid_3 lbl" style="font-weight: bold;color:#7e7789">Duyệt</div>                                                       '
        html += '            <div class="grid_13 val">                                                                                                            '
        html += '                <input type="checkbox" name="ApproveState"  data-bind="checked:form.ApproveState" style="margin-right:10px;" />          '
        html += '            </div>                                                                                                                               '
        html += '            <div class="grid_3 lbl" style="margin-top:5px;font-weight: bold;color:#7e7789" style="font-weight: bold;">Ghi chú</div>             '
        html += '            <div class="grid_13 val"><textarea style="width:272px;height:60px;" class="z-text" data-bind="value:form.GhiChu" ></textarea></div> '
        html += '            <div class="clear"></div>                                                                                                            '
        html += '        </div>                                                                                                                                   '
        html += '    </div>                                                                                                                                       '
        html += '    <div id="w_audit_div_button" class="audit_button">                                                                                           '
    ...
    var viewModel = function () {
        var self = this;
        this.form = {
            ApproveState: args[0].ApproveState(),
            GhiChu: ko.observable('')
        };
        this.confirmClick = function () {
            winAudit.dialog('close');
            if (typeof args[1] === 'function') {
                args[0].ApproveState(this.form.ApproveState);
               // args[0].GhiChu(this.form.GhiChu);
                args[1].call(this, ko.toJS(self.form));
            }
        };
        this.cancelClick = function () {
